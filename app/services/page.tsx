...
export const metadata: Metadata = {
  ...
  description:
    "Creative agency services across Nigeria. Brand films, photography, digital marketing, branding, creative direction, and web design. Four disciplines under one roof.",
